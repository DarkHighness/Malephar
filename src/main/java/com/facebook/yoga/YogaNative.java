...
public class YogaNative {
  static {
    Path nativesDir = Paths.get("lib");
    
    System.load(nativesDir.resolve("libyogacore.dll").toAbsolutePath().toString());
    System.load(nativesDir.resolve("libyoga.dll").toAbsolutePath().toString());
  }
